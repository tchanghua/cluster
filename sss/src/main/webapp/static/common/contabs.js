...
/**
 * 因为下面事件中return false ，组织了菜单中下拉菜单回缩的事件，这里将return false
 * 改为了return true；
 * @returns {boolean}
 */
...
function menuItem() {
    ...
    var dataUrl = $(this).attr('href'),
        ...
        flag = true;
    if (dataUrl == undefined || $.trim(dataUrl).length == 0 || $.trim(dataUrl)=='javascript:void(0)'){
        dataUrl = $(this).attr('data-link');
